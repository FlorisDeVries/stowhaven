...
@description('Pre-generated SAS URL for the Gateway Easy Auth Blob Storage token store. Generated by the pipeline using az storage container generate-sas because listServiceSas is not supported on HNS-enabled storage accounts.')
@secure()
